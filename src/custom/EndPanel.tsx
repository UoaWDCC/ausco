  ...
  return (
    <>
      ...
      `}</style>
        ...
        <p style={{ margin: 0 }}>
          <strong>💡 Tip:</strong> When reporting issues or requesting changes, include as much
          detail as possible — screenshots, page names, steps to reproduce problems, or specific
          examples are extremely helpful for faster resolution.
        </p>
      </div>
    </>
  );
