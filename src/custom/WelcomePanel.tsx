    ...
    <>
      ...
      <div className="welcome-panel">
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <ul style={{ marginLeft: "1.25rem", marginBottom: 0 }}>
            ...
            <li style={{ marginBottom: 0 }}>
              <strong>Users</strong> — Stores administrator login credentials. Currently not used
              for public accounts, but must remain in place for admin access.
            </li>
          </ul>
        </div>
        <div style={{ marginBottom: "1.5rem" }}>
        ...
        <div style={{ marginBottom: 0 }}>
          ...
          <ul style={{ marginLeft: "1.25rem", marginBottom: 0 }}>
            <li style={{ marginBottom: "0.5rem" }}>
              <strong>Typical workflow:</strong> Use <strong>Globals</strong> to update page
              content, and <strong>Gallery Album Media</strong> to upload images for gallery albums.
            </li>
            <li style={{ marginBottom: 0 }}>
