  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">
      <div className="relative w-full md:w-3/5 lg:w-3/5 aspect-video rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-[#602C0F] px-2 py-4 lg:p-16">
          <Eye color="#602c0f" className="size-[40px] sm:size-[35px]"/> <h3 className="text-3xl lg:text-5xl font-bold my-4">{content.visionCard.title}</h3>
          <p className="text-sm md:text-base">{content.visionCard["short-desc"]}</p>
        </div>
      </div>
    ...
    <div className="relative w-full md:w-2/5 lg:w-2/5 aspect-video rounded-lg overflow-hidden shadow-sm">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-[#264C84] px-2 py-4 lg:p-16">
        <History color="#264c84" className="size-[35px] sm:size-[35px]"/> <h3 className="text-3xl lg:text-5xl font-bold my-4">{content.historyCard.title}</h3>
        <p className="text-sm md:text-base">{content.historyCard["short-desc"]}</p>
      </div>
    </div>
  </div>
  </div>
