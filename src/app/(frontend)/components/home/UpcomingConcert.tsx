    ...
    return (
      <section className="bg-[#eee5d8] text-[#602c0f] mx-auto">
        ...
        <div className="flex flex-row gap-16 justify-center mt-4">
          ...
          className="w-80 h-auto mr-4 border-2 border-[#602c0f] rounded-md mt-12" />
          <div className="w-96 text-sm text-left mt-0">
            <p className="mt-0">Love, Passion, and Loss. Our Semester 1 concert delves into the trials and the tribulations of romance and its all-encompassing nature - as well as the grief we feel in its absence</p>
