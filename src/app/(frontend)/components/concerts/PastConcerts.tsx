              ...
              return (
                <div key={yearData.year}>
                  <div>
                    ...
                    <h1 className="text-[var(--brown)] text-2xl sm:text-3xl md:text-4xl font-bold">
                      {yearData.year}
                    </h1>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row relative bg-[var(--beige)] w-full mt-10 mb-16 lg:mt-14 lg:mb-20 gap-8 p-6 lg:p-8 lg:aspect-[16/7] rounded-lg overflow-hidden shadow-sm">
                    ...
                    <div className="flex flex-col md:flex-row relative w-full md:w-1/2 h-full">
                      ...
                      <div className="flex flex-col w-full md:w-1/2 md:my-8 lg:my-16 md:mx-8 text-[var(--brown)]">
                        ...
                        <h2 className="text-xl font-heading font-bold italic mt-2 mb-4">
                          {semester1.concertTitle}
                        </h2>
                        ...
                        <p className="italic md:leading-tight">
                          ${semester1.charity.donationAmount} donated to{" "}
                          <Link
                            href={semester1.charity.websiteURL}
                            target="_blank"
                            className="hover:underline"
                          >
                            {semester1.charity.name}
                          </Link>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row relative w-full md:w-1/2 h-full">
                      ...
                      <div className="flex flex-col w-full md:w-1/2 md:my-8 lg:my-16 md:mx-8 text-[var(--brown)]">
                        ...
                        <hr className="border-t-[1px] border-[var(--brown)] md:mb-4 sm:mb-6" />
                        <p className="italic md:leading-tight">
                          ${semester2.charity.donationAmount} donated to{" "}
                          <Link
                            href={semester2.charity.websiteURL}
                            target="_blank"
                            className="hover:underline"
                          >
                            {semester2.charity.name}
                          </Link>
                        </p>
                      </div>
                    </div>
