...
const ComingSoon = ({ title, description, matineeData, concertData }: ComingSoonProps) => {
  return (
    <div className="bg-[var(--beige)] min-h-screen p-8 flex items-center justify-center">
      <section className="max-w-7xl w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="inline-block bg-[var(--brown)] text-[var(--cream)] px-7 py-3.5 rounded-2xl text-sm font-medium">
                  Semester 2
                </div>
                <h1 className="text-[45px] text-[var(--brown)] italic font-light">
                  {title || "Coming soon!"}
                </h1>
              </div>
              <p className="text-[var(--brown)] max-w-md leading-relaxed">
                {description ||
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud."}
              </p>
            </div>

            <div className="border-t border-[var(--brown)] pt-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[var(--brown)] rounded-2xl p-8 h-full min-h-[300px] flex items-center justify-center">
